...
class fren_Collins {
    ...
    async displayName() {
        ...
        if (locale.indexOf('EN') != -1) return 'French -> English | Collins';
        return 'Francés -> Inglés | Collins';
    }
    ...
    async findCollins(word) {
        ...
        let dictionary = doc.querySelector('.cB.cB-def.dictionary.biling.benedict');
        ...
        let definitions = [];
        let defblocks = dictionary.querySelectorAll('.content.definitions.dictionary.biling.benedict') || [];
