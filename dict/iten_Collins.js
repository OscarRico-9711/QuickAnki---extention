...
class iten_Collins {
    ...
    async displayName() {
        ...
        if (locale.indexOf('EN') != -1) return 'Italian -> English | Collins';
        return 'Italiano -> Inglés | Collins';
    }
    ...
    async findCollins(word) {
        ...
        let base = 'https://www.collinsdictionary.com/dictionary/italian-english/';
        ...
        let dictionary = doc.querySelector('.cB.cB-def.dictionary.biling');
        ...
        let definitions = [];
        let defblocks = dictionary.querySelectorAll('.content.definitions.dictionary.biling') || [];
        for (const defblock of defblocks) {
            let pos = T(defblock.querySelector('.pos'));
            pos = pos ? `<span class="pos">${pos}</span>` : '';
            let eng_tran = T(defblock.querySelector('.sense .quote.ref'));
            ...
            let examps = defblock.querySelectorAll('.re.type-phr .form.type-phr.orth') || '';
            let examps1 = dictionary.querySelectorAll('.re.type-phr .cit.type-translation') || '';
